...
export default function EditCocurricular() {
  const navigate = useNavigate();

  return (
    <div className="min-h-screen bg-[#f4f6f9] font-sans pb-10">
      <div className="bg-white p-6 border-b border-slate-200">
        <h1 className="text-xl font-bold text-slate-800">Edit Cocurricular Area</h1>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden h-fit">
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex justify-end gap-3">
              ...
              >
                <span className="text-sm">💾</span> Update Area
              </button>
            </div>
          </div>
